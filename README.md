...
ECI Framework — Eternal Codex Infinitus is released under the
ECI Non-Commercial License v1.0.

Permitted Use

The ECI Framework may be freely used for:
...
Without a separate written commercial license, the framework may not be:

Sold, licensed, sublicensed, or monetized

Incorporated into a commercial product or service

Used in paid client or consulting projects

Deployed as part of a revenue-generating service

Used for commercial internal business operations

Distributed commercially

Used to create, sell, license, or monetize a commercial derivative work

Used by a commercial organization for commercial or revenue-generating purposes

Commercial, enterprise, institutional, or other uses outside the permissions granted by the license require a separate written agreement with the copyright holder.

Attribution & Derivative Works

Forks, extensions, modifications, and other derivative works are permitted only for non-commercial purposes and must preserve the original authorship and copyright attribution.

The following attribution must remain clearly visible and must not be removed, obscured, or replaced:
...
Any publicly distributed fork, extension, or derivative work must clearly state that it is derived from the ECI Framework and must preserve the original copyright notice and this license.

Additional contributors may be credited for their own contributions, but contributor attribution does not replace or supersede the original authorship of Arash Mansourpour.

No derivative work, fork, extension, modification, or successor project based on ECI Framework may falsely represent the original work as the exclusive creation of another person or organization.

AI / ML Use

Non-commercial academic and scientific use involving AI and machine learning is permitted.

Commercial use of the ECI Framework for training, fine-tuning, evaluation, development, deployment, or operation of commercial AI, machine-learning, foundation, generative, or autonomous-agent systems requires prior written permission.

Ownership

The original ECI Framework source code, architecture, algorithms, protocols, documentation, designs, and associated intellectual property remain the property of Arash Mansourpour, except for separately identified third-party components governed by their own licenses.

This license does not transfer ownership or copyright.

Commercial Licensing

Commercial licensing, enterprise use, commercial integration, commercial deployment, and other uses outside this license may be authorized through a separate written agreement with the copyright holder.
