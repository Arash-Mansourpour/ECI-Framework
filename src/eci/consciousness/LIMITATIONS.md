...
| IIT 4.0 distinctions/relations/Phi, `iit4.py` | Structural theorems verified exactly (disconnected⇒Φ=0; COPY photodiode Φ=1; AND cause repertoire = hand-derived point mass; relation zero without overlap) | Absolute magnitudes NOT benchmarked against PyPhi/published tables — candidate reference values are in the Phase 3 report, pending cross-check |
